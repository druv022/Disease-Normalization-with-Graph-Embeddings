...
class Word2VecFeatureExtractor(VectorFeatureExtractor):
    def __init__(self):
        super().__init__()
        self.key = KEY
    ...
    def load(self, file_path):
        ...
        model_load_path = load_path.joinpath("word2vec.model")
        config_load_path = load_path.joinpath("word2vec.config")
